...
5. Als je nou onverhoopt toch een keer positief test maar niet ziek bent, dan ben je fit genoeg om thuis verder te werken. In dat geval kun je gewoon assistentie van ons krijgen via een videoverbinding. Je moet dit per mail melden, zonder bewijs ([hoe fake je een zelftest](https://theconversation.com/covid-19-kids-are-using-soft-drinks-to-fake-positive-tests-ive-worked-out-the-science-and-how-to-spot-it-163739)). We gaan er van uit dat dit een keer kan gebeuren, maar het zal waarschijnlijk niet bij één student meermaals gebeuren. Dit is dus een beperkt aanbod.
